...
// // Assuming markers is an array of your data with a 'category' field
// const markersData = markers;

// // Create a MarkerClusterGroup for each category
// const categories = {
//   category1: L.markerClusterGroup({ maxClusterRadius: zoom => {...} }),
//   category2: L.markerClusterGroup({ maxClusterRadius: zoom => {...} }),
//   // Add more categories as needed
// };

// // Add markers to the relevant MarkerClusterGroup based on their category
// markersData.forEach(markerData => {
//   const marker = (
//     <Marker
//       position={[markerData.latitude, markerData.longitude]}
//       icon={getCustomIcon(markerData.room_type)}
//     >
//       <Popup className='customPopup'>
//         {/* Your Popup content */}
//       </Popup>
//     </Marker>
//   );
//   categories[markerData.category].addLayer(marker);
// });

// // Add the MarkerClusterGroups to the map
// const categoryLayers = Object.values(categories).map((category, index) => (
//   <MarkerClusterGroup key={index} maxClusterRadius={zoom => {...}}>
//     {category.getLayers()}
//   </MarkerClusterGroup>
// ));
